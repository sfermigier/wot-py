...
SCHEMA_ID = {"oneOf": [{"type": "string"}, {"type": "integer"}, {"type": "null"}]}
...
SCHEMA_REQUEST = {
    ...
    "type": "object",
    "properties": {
        "jsonrpc": {"type": "string", "enum": [JSON_RPC_VERSION]},
        "method": {"type": "string", "enum": WebsocketMethods.list()},
...
SCHEMA_EMITTED_ITEM = {
    ...
    "required": ["subscription", "name", "data"],
}
...
SCHEMA_PARAMS_INVOKE_ACTION = {
    ...
    "type": "object",
    "properties": {"name": {"type": "string"}, "parameters": {}},
    "required": ["name"],
}
